...
#set_property PACKAGE_PIN B10        [get_ports "pmod[2]"]
#set_property PACKAGE_PIN E10        [get_ports "pmod[3]"]
#set_property PACKAGE_PIN E12        [get_ports "pmod[4]"]
#set_property PACKAGE_PIN D10        [get_ports "pmod[5]"]
#set_property PACKAGE_PIN D11        [get_ports "pmod[6]"]
#set_property PACKAGE_PIN C11        [get_ports "pmod[7]"]
